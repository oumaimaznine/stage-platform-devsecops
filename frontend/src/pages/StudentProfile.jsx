...
export default function StudentProfile() {
  ...
  const hasAnyLink = linkItems.some((item) => item.url);
  ...
  const Input = ({ label, ...props }) => (
    <div>
      <label className="block text-xs font-semibold text-[#526970] mb-2">
        {label}
      </label>
                  ...
                  {student.cv_extracted && (
                    ...
                    >
                      ...
                      {Array.isArray(
                        ...
                        student.cv_extracted.competences.length >
                          0 && (
                          <div className="mb-5">
                            ...
                            <div className="flex flex-wrap gap-2">
                              ...
                              {student.cv_extracted.competences.map(
                                (competence, index) => (
                                  <span
                      ...
                      {Array.isArray(
                        student.cv_extracted.diplomes
                      ) &&
                        student.cv_extracted.diplomes.length >
                          0 && (
                          <div className="mb-5">
                            ...
                            <div className="space-y-2">
                              ...
                              {student.cv_extracted.diplomes.map(
                                (diplome, index) => (
                                  <div
                                    key={index}
                                    className="
                      ...
                      {Array.isArray(
                        ...
                        student.cv_extracted.experiences.length >
                          0 && (
                          <div className="mb-5">
                            ...
                            <div className="space-y-2">
                              ...
                              {student.cv_extracted.experiences.map(
                                (experience, index) => (
                                  <div
                                    key={index}
                                    className="
                      ...
                      {Array.isArray(
                        student.cv_extracted.langues
                      ) &&
                        student.cv_extracted.langues.length >
                          0 && (
                          <div>
                            ...
                            <div className="flex flex-wrap gap-2">
                              ...
                              {student.cv_extracted.langues.map(
                                (langue, index) => (
                                  <span
                                    key={`${langue}-${index}`}
                                    className="
